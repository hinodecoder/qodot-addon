...
Original Godot 4.0 porting done by [EIRTeam](https://github.com/EIRTeam) however their port appears abandoned and no longer functions.

This version is also modified to work with the native engine module which you can find [here](https://github.com/studioembyr/qodot-module).
...
[Josh Palmer](https://twitter.com/ShiftyAxel) - For originally creating Qodot
